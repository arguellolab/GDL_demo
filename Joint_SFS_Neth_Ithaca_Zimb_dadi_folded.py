...
fs_N_I_Z = fs.marginalize([0,3]) # w/o 1,2,4

# dim fs_NIZ
fs_N_I_Z.to_file("SFS_N_I_Z_folded.txt")

SegS_fs_N_I_Z = fs_N_I_Z.S()
print("The number of segregating sites:  {0}".format(SegS_fs_N_I_Z))
